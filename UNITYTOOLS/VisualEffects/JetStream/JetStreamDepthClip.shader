...
Shader "Custom/JetStreamDepthClip"
{
	Properties
	{
	...
	SubShader
	{
		Tags { "RenderType"="Transparent" "Queue"="Transparent+900" "DisableBatching"="True"}
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				//Depth
				float cD = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE_PROJ(_CameraDepthTexture, UNITY_PROJ_COORD(i.screenPos)));
